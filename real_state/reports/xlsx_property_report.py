...
class XlsxProperty(http.Controller):

    @http.route("/property/excal/report/<string:property_ids>", type="http", auth="user")
    def download_property_excal_report(self, property_ids):
